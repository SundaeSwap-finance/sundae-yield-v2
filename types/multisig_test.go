	...
	testCases := []testCase{
		{
			...
			script: MultisigScript{Signature: &Signature{KeyHash: mustDecode(t, "6a5cf1e931c3bd034543b93ef9731cf16847e038b020033db359786d")}},
		},
		{
			label: "AllOf",
			...
			script: MultisigScript{AllOf: &AllOf{
		...
		},
		{
			...
			script: MultisigScript{AtLeast: &AtLeast{
				Required: 2,
				Scripts: []MultisigScript{
					{Signature: &Signature{KeyHash: mustDecode(t, "6a5cf1e931c3bd034543b93ef9731cf16847e038b020033db359786d")}},
					{Signature: &Signature{KeyHash: mustDecode(t, "6a5cf1e931c3bd034543b93ef9731cf16847e038b020033db359786d")}},
